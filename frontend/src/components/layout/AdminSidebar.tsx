    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gray-900 flex flex-col z-40">
      ...
      <div className="h-16 lg:h-20 flex items-center px-6 border-b border-gray-800">
        <Link href="/" className="flex items-center gap-2">
          ...
          <div>
            <span className="font-display font-bold text-lg text-white block">AI Club</span>
            <span className="text-xs text-primary-400">Admin Panel</span>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-gray-800 space-y-1">
        <Link
          href="/dashboard"
          className="flex items-center gap-3 px-4 py-3 w-full rounded-xl font-medium text-gray-400 hover:bg-gray-800 hover:text-white transition-colors"
        >
        ...
        <button
          onClick={logout}
          className="flex items-center gap-3 px-4 py-3 w-full rounded-xl font-medium text-red-500 hover:bg-red-900/20 transition-colors"
        >
